 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const ca=da(class extends la{constructor(r){var e;if(super(r),r.type!==ua.ATTRIBUTE||r.name!=="class"||((e=r.strings)===null||e===void 0?void 0:e.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(r){return" "+Object.keys(r).filter(e=>r[e]).join(" ")+" "}update(r,[e]){var t,n;if(this.nt===void 0){this.nt=new Set,r.strings!==void 0&&(this.st=new Set(r.strings.join(" ").split(/\s/).filter(i=>i!=="")));for(const i in e)e[i]&&!(!((t=this.st)===null||t===void 0)&&t.has(i))&&this.nt.add(i);return this.render(e)}const a=r.element.classList;this.nt.forEach(i=>{i in e||(a.remove(i),this.nt.delete(i))});for(const i in e){const o=!!e[i];o===this.nt.has(i)||!((n=this.st)===null||n===void 0)&&n.has(i)||(o?(a.add(i),this.nt.add(i)):(a.remove(i),this.nt.delete(i)))}return W}});class ar extends D{static get properties(){return{search:{type:String},cities:{type:Object}}}constructor(){super(),this.search="buenos aires",this.cities={}}render(){return S`
    ...
    `}searchValue(e){return async t=>{let n=t.target.value;this[e]=await Wn(n),this.onSearch(),this.dispatchEvent(new CustomEvent("onInput"))}}onSearch(){let t={detail:{cities:this.cities},bubble:!0,composed:!0};this.dispatchEvent(new CustomEvent("search",t))}onBlur(){this.dispatchEvent(new CustomEvent("onBlur"))}}N(ar,"styles",j`
    * {
  ...
  `);customElements.define("search-input",ar);class ir extends D{static get properties(){return{isExistsCountry:{type:Boolean,attribute:!0}}}render(){return S`
      <div>${this.isExistsCountry?S` <span>the location already exists</span> `:""}</div>
    `}}N(ir,"styles",[j`
      :host {
        display: block;
      }
    `]);customElements.define("notification-component",ir);class or extends D{static get properties(){return{place:{Type:String,attibute:!0},name:{Type:String,attibute:!0},countryCode:{Type:String,attibute:!0},latitude:{Type:Number,attibute:!0},longitude:{Type:Number,attibute:!0}}}render(){return this.countryCode=this.countryCode.toLowerCase(),S`
      <li>
        <a>
    ...
    `]);customElements.define("list-countries-search",or);class sr extends D{static get properties(){return{citiesResult:{type:Object},selectedCountries:{type:Array},existsCountry:{type:Boolean},isFocused:{type:Boolean}}}constructor(){super(),this.isFocused=!0,this.citiesResult={},this.selectedCountries={},this.existsCountry=!1}addWeatherCard(e){let t=e.detail.cities;t&&(this.citiesResult=t,this.isFocused=!0)}countrySelected(e,t,n,a){let i={},o=n+a;o=o.replace(/ /g,"");let s=X();if(Object.values(s).some(f=>f.id===o))this.existsCountry=!0;else{i.country=a,i.city=n,i.latitude=e,i.longitude=t,i.id=o;let m={detail:{selectedCountries:i},bubble:!0,composed:!0};this.dispatchEvent(new CustomEvent("cities",m))}this.isFocused=!0}onInput(){this.isFocused=!1}hiddenListCountries(){this.isFocused=!0}render(){return S`
      <div>
        <search-input
    ...
    `]);customElements.define("search-component",sr);/**
 * @license
